...
// Plaid y Prometeo no se pueden conectar por ahora (Prometeo además disparó un
// aviso de phishing de Google Safe Browsing por pedir credenciales bancarias
// reales en un dominio no-bancario). Se sacaron del todo de Configuración —
// el backend/endpoints quedan intactos por si se retoman más adelante.
const Settings = {
  async render() {
  ...
  _buildCsvImportCard() {
    ...
    icon.innerHTML = Icon('document', 20);
