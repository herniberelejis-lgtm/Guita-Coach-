...
2. **La página de venta** — hardware, demos scrubbeados, panel con capturas
   reales, cómo funciona, simulador ROI, comparativa, planes, FAQ y CTA.
...
| `assets/img/` | Posters de cada beat y las seis capturas del panel |
